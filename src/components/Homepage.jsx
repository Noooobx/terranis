...
const Homepage = () => {
  return (
    <div className="homepage text-white">
      ...
      <section
        id="contact"
        className="py-20 bg-gradient-to-b h-screen from-gray-900 to-black text-white flex items-center justify-center"
      >
        <div className="max-w-6xl w-full mt-12 px-8">
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-12 tracking-wide">
            Get in Touch
          </h2>

          <div className="bg-gray-800 p-10 rounded-2xl shadow-2xl max-w-3xl mx-auto">
            ...
            <div className="space-y-6 flex flex-col items-center">
              {[...Array(2)].map((_, index) => (
                <a
                  ...
                  className="flex items-center text-gray-300 text-lg hover:text-green-400 transition duration-300 transform hover:scale-105"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-7 w-7 text-green-500 mr-4"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <span className="ml-2 text-lg font-medium">
                    <strong className="">John</strong> +91 98765
                    43211
                  </span>
                </a>
              ))}
